...
* **coda_glmnet**: Identification of microbial signatures in cross-sectional studies.
    ...
    A graphical representation of the taxa that constitutes the signature and their coefficients is provided as an element of the output. The output also includes a plot of the prediction or classification accuracy. 
